    ...
    <div className="container mx-auto p-0 bg-transparent min-h-screen rounded-lg">
      ...
      <div className="mt-8">
        <div className="flex justify-between items-center">
          ...
          <button className="bg-[#428F8F] text-white p-3 rounded-full shadow-md">
        ...
        <div className="space-y-4 mt-4">
          {events.map((event, idx) => (
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                {/* Edit Button */}
                <button className="p-4 rounded-full text-[#B64B29] absolute right-0 -bottom-2">
          ...
          <div className="relative p-4 rounded-lg shadow-md bg-[#f3f4f6]">
            ...
            <div className="flex justify-center items-center h-20">
              <button className="p-3 bg-white text-[#B64B29] border-2 border-[#B64B29] rounded-full shadow-md">
