  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div>
          <RecipeCard
            recipe={/* your recipe data */}
            savedRecipesData={/* your saved recipes data */}
            onToggleFavorite={/* your onToggleFavorite function */}
            onToggleBookmark={/* your onToggleBookmark function */}
          />
        </div>
      </motion.div>
    </AnimatePresence>
