...
import { setModalOpen } from '@/store/modalSlice'; // Import the action to control modal state
...
const SignInPage: React.FC = () => {
  ...
  const handleClose = () => {
    router.push('/'); // Navigate back to the home page or any other route when closing
  };
